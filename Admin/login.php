<?php 
session_start();
$koneksi = new mysqli("localhost" , "root" , "" , "dilanstore")
 ?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Barqi-Electronic | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="admin/login.php"><b>Barqi</b>Electronic</a>
  </div>
  <!-- /.login-logo -->
    ...
    <?php 
      if (isset($_POST['login'])) {
        ...
        if ($cocok==1) {
          ...
          echo "<div class='alert alert-success'> Login Suskes </div>";
